...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Tyler Vick"
    user-mail-address "tyler@milo.cat")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/tyler/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/tyler/bin" "/profile/bin" "/Users/tyler/.npm-packages/bin" "/Users/tyler/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
